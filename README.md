...
cuHALLaR solves the primalâ€“dual pair of semidefinite programs (SDPs)
...
3.  **Set Permissions and Run**
    ...
    A successful run will produce the following output, confirming the solver is ready to use âœ…:
...
- H200 + Red Hat Enterprise Linux 9.5 (â€œPlowâ€)
- H100 + Red Hat Enterprise Linux 9.5 (â€œPlowâ€)
- A100 + Red Hat Enterprise Linux 9.5 (â€œPlowâ€)
- RTX3080 + Ubuntu 22.04 (â€œJammy Jellyfishâ€)
...
| **Stopping Criteria**        |                    |                                                                                                                                                          |
| `--eps_pfeas`                | `1e-5`             | Primal feasibility tolerance (Îµ_feas).                                                                                                                  |
| `--eps_gap`                  | `1e-5`             | Relative duality gap tolerance (Îµ_gap).                                                                                                                 |
| **Penalty Parameters**       |                    |                                                                                                                                                          |
| `--beta0`                    | `10.0`             | Initial penalty parameter Î²â‚€.                                                                                                                         |
| `--beta_inc`                 | `1.5`              | Increment factor for Î².                                                                                                                                 |
| `--beta_min`                 | `10.0`             | Minimum value for Î².                                                                                                                                    |
| `--beta_max`                 | `1e11`             | Maximum value for Î².                                                                                                                                    |
| **Scaling**                  |                    |                                                                                                                                                          |
...
| `--trace_bound`              | `-1.0`             | Ï„ value for the trace constraint. Used when passing a sparse SDPA format file. When using HSLR format, the trace bound is passed inside the input file. |
